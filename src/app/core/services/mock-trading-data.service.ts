...
import { InventoryPage, InventoryPageRequest } from '@features/slabdashboard/inventory/models/inventory-page.model';
import { InventoryRow } from '@features/slabdashboard/inventory/models/inventory-row.model';
import { SingleNameDetail } from '@features/slabdashboard/single-name/models/single-name.model';
      ...
      drilldown: [
        {
          ...
          market: 'US',
          account: '214',
          description: 'Start of day position',
          projected214: -8525,
          settled214: 75,
          projectedTotal: -8525,
          settledTotal: 75,
        },
        {
          ...
          market: 'US',
          account: '214',
          description: 'CNS settlement activity',
          projected214: -11896,
          settled214: -11896,
          pending214: -5889,
          projectedTotal: -11896,
          settledTotal: -11896,
          pendingTotal: -5889,
        },
        {
          ...
          market: 'US',
          account: '2864',
          description: 'New borrow projection',
          settled214: 7275,
          projected2864: 8600,
          settled2864: 8600,
          projectedTotal: 8600,
        ...
        },
        {
          ...
          market: 'US',
          account: '2864',
          description: 'Internal custody movement',
          projected2864: 8600,
          settled2864: 8600,
          projectedTotal: 8600,
          settledTotal: 8600,
        },
        {
          ...
          market: 'US',
          account: '2864',
          description: 'DTC receives',
          settled2864: 8600,
          settledTotal: 8600,
        },
        {
          category: 'StockLoan',
          activityType: 'LoanReturn',
          market: 'US',
          account: '214',
          description: 'Loan return pending receive',
          pending214: 1200,
          pendingTotal: 1200,
        },
        {
          category: 'Recalls',
          activityType: 'BorrowRecall',
          market: 'US',
          account: '214',
          description: 'Borrow recall included in ex/def',
          projected214: -500,
          pending214: -500,
          projectedTotal: -500,
          pendingTotal: -500,
        ...
        {
          category: 'NonEntitlement',
          activityType: 'NonEntitlementMove',
          market: 'US',
          account: 'N/E',
          description: 'Non-entitlement activity',
          isNonEntitlement: true,
          projected214: -250,
          projectedTotal: -250,
        },
        {
          ...
          market: 'US',
          account: '214',
          description: 'Empty row placeholder',
          isEmpty: true,
        },
      ],
    };
